...
const achievements = [
  ...
  },
  {
    ...
    organization: "Utsav 2025 (Annual Cultural Festival), SASTRA",
    year: "2024 - 2025",
  },
  {
    icon: Trophy,
    title: "Internal Finalist",
    organization: "Smart India Hackathon (SIH) - AI Civil Solutions",
    year: "2024",
  },
  {
    icon: Trophy,
    title: "Internal Finalist",
    organization: "Daksh AI Hackathon - Machine Learning in Construction",
    year: "2025",
  },
];
