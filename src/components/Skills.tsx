...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["BIM MANAGEMENT", "PROJECT PLANNING", "STRUCTURAL ANALYSIS", "BIM MODELING", "CONSTRUCTION PLANNING & EXECUTION", "CONSTRUCTION MANAGEMENT", "AI-DRIVEN CONSTRUCTION WORKFLOWS", "PROBLEM SOLVER", "INNOVATOR"],
    icon: Cpu,
    id: "MOD_05",
    bgClass: "bg-foreground/5",
    borderClass: "border-foreground/10",
